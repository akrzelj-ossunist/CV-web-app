...
function AddJob( {object, getObject, setCounterNext, setCounterBack, num} ){
    ...
    return (
        <form>
            Job name: <input onInput={el => getJobObject({...jobObject, name: el.target.value})} type='text'></input><br></br><br></br>
            Job address: <input onInput={el => getJobObject({...jobObject, address: el.target.value})} type='text'></input><br></br><br></br>
            Job email: <input onInput={el => getJobObject({...jobObject, email: el.target.value})} type='text'></input><br></br><br></br>
            Job phone: <input onInput={el => getJobObject({...jobObject, phone: el.target.value})} type='text'></input><br></br><br></br>
...
function RepairJob( {object, getObject, setCounterNext, setCounterBack, Id} ){
    ...
    return (
        <form>
            Job name: <input value={job.name} onInput={el => changeJob({...job, name: el.target.value})} type='text'></input><br></br><br></br>
            Job address: <input value={job.address} onInput={el => changeJob({...job, address: el.target.value})} type='text'></input><br></br><br></br>
            Job email: <input value={job.email} onInput={el => changeJob({...job, email: el.target.value})} type='text'></input><br></br><br></br>
            Job phone: <input value={job.phone} onInput={el => changeJob({...job, phone: el.target.value})} type='text'></input><br></br><br></br>
            <input onClick={el => getVal(el.target.value)} type='button' value='save'></input>
            <input onClick={el => getVal(el.target.value)} type='button' value='cancel'></input>
        </form>
    )
